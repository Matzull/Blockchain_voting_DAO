...
el n ́umero m ́aximo de tokens que se van a poner a la venta para votaciones. Entre otras
cosas, el constructor debe crear el contrato de tipo ERC20 que gestiona los tokens. En
la secci ́on 3 se proporcionan m ́as detalles sobre el c ́odigo del est ́andar ERC20.
...
4 / 9
Proyecto – Gobernanza y sistemas de votaci ́on
...
todas cuando se cierra el proceso con closeVoting.
5 / 9
Proyecto – Gobernanza y sistemas de votaci ́on
Cuando se realice la llamada a executeProposal del contrato externo, se debe limitar la
